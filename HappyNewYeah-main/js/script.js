...
const WISH_MESSAGES = [
	"Happy New Year Bé Hón❤️",
	"Năm Mới Bình An và An Khang Thịnh Vượng",
	"Chúc Mọi Điều Ước Của You Đều Trở Thành Hiện Thực ✨",
	"Chúc Gia Đình You Luôn Bình An Và Hạnh Phúc ❤️",
	"Chúc You Luôn Khỏe Mạnh và Tràn Đầy Năng Lượng 💪",
	"Chúc You Mọi Thứ Đều Thuận Lợi Ạ ",
	"Chúc You Luôn Vui Vẻ Và Yêu Đời Mỗi Ngày 😊",
	"Chúc You Gặp Nhiều May Mắn và Mọi Thứ Tốt Đẹp Nhất Ạ 🎉",
];
